...
$(document).ready(function () {
    $('.flator').on('click', function () {
        $('.flanav').toggleClass('itson');
        $(this).toggleClass('itsoff');
    })
    ...
    if ($(window).width() > 767) {
        $(window).scroll(function () {
            ...
            if ($(window).scrollTop() > 1) {
                $('.flanav').addClass('itson');
                $('.flator').addClass('itsoff');
            } else {
                $('.flanav').removeClass('itson');
                $('.flator').removeClass('itsoff');
            }
        });
    }
});
